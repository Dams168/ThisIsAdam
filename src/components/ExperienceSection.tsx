...
const experiences = [
  {
    ...
    highlights: [
      ...
      'Developed and structured various secure backend RESTful APIs using Java Spring Boot for a glucose clamp system, ensuring precision data handling and reliable system performance.',
    ],
